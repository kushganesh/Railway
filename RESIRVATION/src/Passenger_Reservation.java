...
public class Passenger_Reservation  implements ActionListener , FocusListener {
    ...
    Passenger_Reservation()
    {
        ...
        frame.setBounds(400,60,500,420);
        ...
        l1.setBounds(70,25,120,25);

        t1=new JTextField();
        t1.setBounds(175,24,240,25);
        ...
        l2.setBounds(70,65,120,25);

        t2=new JTextField();
        t2.setBounds(175,64,240,25);
        ...
        choice.setBounds(175,105,240,25);


        l5=new JLabel("From  :");
        l5.setFont(new Font("serif",Font.BOLD,17));
        l5.setForeground(Color.WHITE);
        l5.setBounds(70,152,150,25);


        t4=new JTextField();
        t4.setBounds(175,152,240,25);
        ...
        l4.setBounds(70,232,150,25);


        t3=new JTextField("YY-MM-DD");
        t3.setBounds(210,232,200,25);
